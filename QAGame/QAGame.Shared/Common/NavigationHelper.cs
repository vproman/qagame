...
#if WINDOWS_PHONE_APP
        /// <summary>
        /// Represents the method that will handle the <see cref="NavigationHelper.BackPressed"/>event
        /// </summary>
        public delegate void BackPressedEventHandler(object sender, Windows.Phone.UI.Input.BackPressedEventArgs e);
        /// <summary>
        /// Register this event on the current page to possibly
