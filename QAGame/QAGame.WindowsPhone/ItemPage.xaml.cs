...
namespace QAGame
{
    ...
    public sealed partial class ItemPage : Page
    {
        ...
        private void SetFirstRunActive(bool firstRunActive)
        {
            ...
            ContentRoot.IsHitTestVisible = !firstRunActive;
            ...
            ContentRoot.Opacity = mainOpacity;
        }
        ...
        void HardwareButtons_BackPressed(object sender, Windows.Phone.UI.Input.BackPressedEventArgs e)
        {
            ...
            if (_firstRunActive)
            {
                if (_firstRunIndex > MIN_FIRSTRUNINDEX)
                {
                    _firstRunIndex--;
                }
                else
                {
                    ...
                    Frame.Navigate(typeof(HubPage), _firstRunIndex - 1);
                }
                UpdateFirstRunCanvas();
                e.Handled = true;
                return;
